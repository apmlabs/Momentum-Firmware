...
Download source code for your preferred Flipper Zero firmware. The most popular unofficial distributions are [Momentum](https://github.com/next-flip/Momentum-Firmware), [Lambda](https://github.com/Lambda/flipperzero-firmware-wPlugins) and [Unleashed](https://github.com/DarkFlippers/unleashed-firmware), although a variety of other distributions are also available.
...
* Lambda Firmware:
  ...
  ```sh
  git clone https://github.com/Lambda/flipperzero-firmware-wPlugins.git
  ```
