...
### Installation
This app is included in the [Lambda Firmware](https://github.com/Lambda/flipperzero-firmware-wPlugins), or you can build it from source using [ufbt](https://github.com/flipperdevices/flipperzero-ufbt) or [fbt](https://github.com/flipperdevices/flipperzero-firmware/blob/dev/documentation/fbt.md)
