...
static void gauge_tool_process_input(InputEvent* event) {
    if(event->key == InputKeyLeft) {
        furi_hal_i2c_acquire((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
        bq27220_unseal((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
        furi_hal_i2c_release((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
    } else if(event->key == InputKeyOk) {
        furi_hal_i2c_acquire((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
        bq27220_full_access((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
        furi_hal_i2c_release((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
    } else if(event->key == InputKeyRight) {
        furi_hal_i2c_acquire((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
        bq27220_reset((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
        furi_hal_i2c_release((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
    }
}
...
static void gauge_tool_refresh() {
    ...
    gauge_tool_data.battery_status_good =
        bq27220_get_battery_status((FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power, &gauge_tool_data.battery_status);
    gauge_tool_data.operation_status_good = bq27220_get_operation_status(
        (FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power, &gauge_tool_data.operation_status);
    furi_hal_i2c_release((FuriHalI2cBusHandle*)(FuriHalI2cBusHandle*)&furi_hal_i2c_handle_power);
}
