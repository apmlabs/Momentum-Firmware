...
https://github.com/Lambda/flipperzero-firmware-wPlugins/tree/unleashed/applications/wifi_marauder_companion
...
This is already in the Lambda firmware and just needs to be enabled and compiled. unfortunatly I could not get this past the menu when I compiled his deauther source for the nodemcu. Nice menu though.
...
I installed this into Lambda to test.

git clone --recursive https://github.com/Lambda/flipperzero-firmware-wPlugins.git
