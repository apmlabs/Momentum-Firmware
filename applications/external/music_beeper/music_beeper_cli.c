...
static void music_beeper_cli(CliRegistry* cli __attribute__((unused)), FuriString* args, void* context) {
    UNUSED(context);
...
void music_beeper_on_system_start() {
    ...
    cli_registry_add_command(cli, "music_beeper", CliCommandFlagDefault, music_beeper_cli, NULL);
